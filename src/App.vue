...
export default {
  ...
  methods: {
    add(){
      ...
      setInterval(async()=>{
        const f = await fetch(`https://min-api.cryptocompare.com/data/price?fsym=${currentTicker.name}&tsyms=USD&api_key=2d0ec3d247245897757f871161e78b96c07105d990c860fb649f767b3bba8f66`);
